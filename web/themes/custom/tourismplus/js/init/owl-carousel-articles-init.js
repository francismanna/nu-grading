    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-articles').once('mtOwlCarouselArticlesInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.tourismplus.owlCarouselArticlesInit.owlArticlesAutoPlay,
          autoplayTimeout: drupalSettings.tourismplus.owlCarouselArticlesInit.owlArticlesEffectTime,
          nav: true,
          dots: true,
          loop: true,
