    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-testimonials').once('mtowlCarouselTestimonialsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.tourismplus.owlCarouselTestimonialsInit.owlTestimonialsAutoPlay,
          autoplayTimeout: drupalSettings.tourismplus.owlCarouselTestimonialsInit.owlTestimonialsEffectTime,
          nav: true,
          dots: true,
          loop: true,
