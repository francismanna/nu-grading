    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-products').once('mtowlCarouselProductsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.tourismplus.owlCarouselProductsInit.owlProductsAutoPlay,
          autoplayTimeout: drupalSettings.tourismplus.owlCarouselProductsInit.owlProductsEffectTime,
          nav: true,
          dots: false,
          loop: true,
