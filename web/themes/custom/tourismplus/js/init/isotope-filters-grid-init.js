jQuery(document).ready(function($) {
  ...
  filtersMasonry.prepend( "<li class=\"active\"><a href=\"#\" data-filter=\"*\">" + drupalSettings.tourismplus.isotopeFiltersGridInit.isotopeFiltersText + "</a></li>" );
  ...
  masonryContainer.imagesLoaded(function() {
    masonryContainer.isotope({
      ...
      layoutMode : drupalSettings.tourismplus.isotopeFiltersGridInit.isotopeLayoutMode,
